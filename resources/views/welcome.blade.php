...
<head>
    ...
    <title>petable demo project</title>
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="index.htm">
                                        <img src="https://petable.in/public/uploads/settings/63c662d0a81dd.png" class="h-logo img-fluid blur-up lazyload"
                                            alt="logo">
                                    </a>
                                </div>
...
<div class="w3-content w3-section" style="max-width:100%">
  <img class="mySlides" src="https://petable.in/public/uploads/images/03-10-2023/651b11029f7a1.png" style="width:100%">
  <img class="mySlides" src="https://petable.in/public/uploads/images/03-10-2023/651b1250f1db2.png" style="width:100%">
  <img class="mySlides" src="https://petable.in/public/uploads/images/03-10-2023/651b11029f7a1.png" style="width:100%">
</div>
            ...
            <div class="row gy-3">
                <div class="col-xxl-2 col-lg-3">
                    <div class="category-wrap category-padding category-block theme-bg-color">
                        <div>
                            <h2 class="light-text">Pets</h2>
                            <h2 class="top-spacing">Our Pets</h2>
                    ...
                    <div class="category-wrapper category-slider1 white-arrow category-arrow">
                        <div>
                            <a href="shop-left-sidebar.html" class="category-wrap category-padding">
                                <img src="https://images.lifestyleasia.com/wp-content/uploads/sites/5/2021/05/04154535/FENDI-Pet-Travel-Line_Nylon-Coat-e1620117666277-1600x772.jpg" class="bg-img blur-up lazyload"
                                    alt="category image">
                                <div class="category-content category-text-1">
                                    <h3 class="theme-color">Pet</h3>
                        ...
                        <div>
                            <a href="shop-left-sidebar.html" class="category-wrap category-padding">
                                <img src="https://www.versace.com/dw/image/v2/BGWN_PRD/on/demandware.static/-/Sites-ver-master-catalog/default/dw0d781032/original/90_ZDOGCOL04-ZPEL0061_Z1008_22_IconLargePetCollar-For~your~Pet-Versace-online-store_1_2.jpg?sw=550&q=85&strip=true" class="bg-img blur-up lazyload"
                                    alt="category image">
                                <div class="category-content category-text-1">
                                    <h3 class="theme-color">Pet</h3>
                                    <span class="text-dark">Fashion</span>
                        ...
                        <div>
                            <a href="shop-left-sidebar.html" class="category-wrap category-padding">
                                <img src="https://headsupfortails.com/cdn/shop/products/DSC_0899-Edit_3d9c0960-9ee2-4463-b2bc-a83029981a92.jpg?v=1685512550&width=533" class="bg-img blur-up lazyload"
                                    alt="category image">
                                <div class="category-content category-text-1">
                                    <h3 class="theme-color">Pet</h3>
                                    <span class="text-dark">Fashion</span>
        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6">
                    <div class="collection-banner p-bottom p-center text-center">
                        <a href="shop-left-sidebar.html" class="banner-img">
                            <img src="https://headsupfortails.com/cdn/shop/files/DSC_1006-Edit.jpg?v=1689140248&width=533" class="bg-img blur-up lazyload" alt="">
                        </a>
                        ...
                        <a href="shop-left-sidebar.html" class="contain-banner">
                            <div class="banner-content with-big">
                                <h2 class="mb-2">YOUR PET’S DAILY NEEDS</h2>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="collection-banner p-bottom p-center text-center">
                        <a href="shop-left-sidebar.html" class="banner-img">
                            <img src="https://www.poshpuppyboutique.com/cdn/shop/collections/501-T_600x.jpg?v=1612416444" class="bg-img blur-up lazyload" alt="">
                        </a>
                        <div class="banner-detail">
                            <a href="javacript:void(0)" class="heart-wishlist">
                                <i class="far fa-heart"></i>
                        ...
                        <a href="shop-left-sidebar.html" class="contain-banner">
                            <div class="banner-content with-big">
                                <h2 class="mb-2">TRENDING TEES</h2>
                ...
                <div class="col-lg-4">
                    <div class="collection-banner p-bottom p-center text-center">
                        <a href="shop-left-sidebar.html" class="banner-img">
                            <img src="https://m.media-amazon.com/images/I/512POYyZmdL._AC_UF1000,1000_QL80_.jpg" class="bg-img blur-up lazyload" alt="">
                        </a>
                        <div class="banner-detail">
                            <a href="javacript:void(0)" class="heart-wishlist">
                                <i class="far fa-heart"></i>
                        ...
                        <a href="shop-left-sidebar.html" class="contain-banner">
                            <div class="banner-content with-big">
                                <h2 class="mb-2">TOP FOOD BRANDS</h2>
                                <span>BUY ONE GET ONE FREE</span>
                            </div>
                        </a>
                    </div>
            ...
            <div class="product-box">
                        <div class="img-wrapper">
                            <a href="product/details.html">
                                <img src="https://m.media-amazon.com/images/I/81TCohkEf9L._AC_UF1000,1000_QL80_.jpg"
    ...
    <div class="container px-5 py-5">
        <div class="row">
            ...
            <div class="product-box">
                        <div class="img-wrapper">
                            <a href="product/details.html">
                                <img src="https://luxebook.in/wp-content/uploads/2023/07/ezgif.com-gif-maker-12.jpg"
                                    class="w-100 bg-img blur-up lazyload" alt="">
                            </a>
                            <div class="circle-shape"></div>
                            <span class="background-text">Furniture</span>
                ...
                <div class="our-product products-c">
                    <div>
                        <div class="product-box">
                            <div class="img-wrapper">
                                <a href="product/details.html">
                                    <img src="https://images.pexels.com/photos/7210639/pexels-photo-7210639.jpeg?cs=srgb&dl=pexels-blue-bird-7210639.jpg&fm=jpg"
                                        class="w-100 bg-img blur-up lazyload" alt="">
                                </a>
                                <div class="circle-shape"></div>
                    ...
                    <div>
                        <div class="product-box">
                            <div class="img-wrapper">
                                <a href="product/details.html">
                                    <img src="https://media.fatface.com/s/Fat_Face/971731_Navy_PLP_1?%24prod-tile-lge%24&fmt=auto&%24prod-tile-lge%24&layer1=[src=/i/Fat_Face/OnlineOnlyMobile_ROUNDEL&w=15%&right=20&top=50&anchor=TR]"
                                        class="w-100 bg-img blur-up lazyload" alt="">
                                </a>
                                <div class="circle-shape"></div>
                                <span class="background-text">Fashion</span>
                    ...
                    <div>
                        <div class="product-box">
                            <div class="img-wrapper">
                                <a href="product/details.html">
                                    <img src="https://imgmedia.lbb.in/media/2020/11/5fc0b078cb871669edef3fd2_1606463608922.jpg"
                                        class="w-100 bg-img blur-up lazyload" alt="">
                                </a>
                                <div class="circle-shape"></div>
                                <span class="background-text">Fashion</span>
                    ...
                    <div>
                        <div class="product-box">
                            <div class="img-wrapper">
                                <a href="product/details.html">
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTc7dd7Kk0LjQD_0FjbpoxB6W_ZsV_V3DQ5GAbJ_ZoGCjXilCwVxopgzymdn285PzblvJI&usqp=CAU"
                                        class="w-100 bg-img blur-up lazyload" alt="">
                                </a>
                                <div class="circle-shape"></div>
                                <span class="background-text">Fashion</span>
                        ...
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="index.htm" class="footer-logo float-start">
                                    <img src="https://petable.in/public/uploads/settings/63c662d0a81dd.png" class="f-logo img-fluid blur-up lazyload"
                                        alt="logo">
                                </a>
                            </div>
                            <ul class="contact-lists" style="clear:both;">
                                ...
                                <li>
                                    <span><b>Address:</b><span class="font-light"> pondicherry,
                                            India</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> jayasree@gmail.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2023, copyright.</p>
                    </div>
                </div>
            </div>
        </div>
